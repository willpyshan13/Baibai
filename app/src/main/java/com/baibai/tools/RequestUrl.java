...
public class RequestUrl {
    ...
    public static final String ADDATTEND = BASE_REQUSET_PATH +"attend/addAttend?token=";
    public static final String DELATTEND = BASE_REQUSET_PATH +"attend/delAttend?token=";
